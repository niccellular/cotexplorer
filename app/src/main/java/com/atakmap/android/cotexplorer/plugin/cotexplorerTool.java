...
import com.atakmap.android.cotexplorer.cotexplorerDropDownReceiver;
...
public class cotexplorerTool extends Tool implements ToolDescriptor {
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                cotexplorerDropDownReceiver.SHOW_PLUGIN);
