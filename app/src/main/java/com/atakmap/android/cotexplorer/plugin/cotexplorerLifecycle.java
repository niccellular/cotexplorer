...
public class cotexplorerLifecycle implements Lifecycle {
    ...
    private final static String TAG = "adsbexchangeLifecycle";

    public cotexplorerLifecycle(Context ctx) {
    ...
    public void onCreate(final Activity arg0,
        ...
        cotexplorerLifecycle.this.overlays
                .add(new cotexplorerMapComponent());

        // create components
        Iterator<MapComponent> iter = cotexplorerLifecycle.this.overlays
                .iterator();
        MapComponent c;
        while (iter.hasNext()) {
            c = iter.next();
            try {
                c.onCreate(cotexplorerLifecycle.this.pluginContext,
                        arg0.getIntent(),
                        cotexplorerLifecycle.this.mapView);
            } catch (Exception e) {
                Log.w(TAG,
